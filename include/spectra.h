...
struct spectra {
  ...
  int index_tr_delta_icdm;      /**< index of cold dark matter density transfer function mpark */
  ...
  int index_tr_theta_icdm;      /**< index of cold dark matter velocity transfer function mpark */
