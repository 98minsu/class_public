...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_icdm;  /**< do we need source for delta of interacting cold dark matter? mpark */
  ...
  short has_source_theta_icdm;  /**< do we need source for theta of interacting cold dark matter? mpark */
  ...
  int index_tp_delta_icdm; /**< index value for delta of interacting cold dark matter mpark */
  ...
  int index_tp_theta_icdm;  /**< index value for theta of interacting cold dark matter mpark */
...
struct perturb_vector
{
  ...
  int index_pt_delta_icdm; /**< icdm density mpark*/
  int index_pt_theta_icdm; /**< icdm velocity mpark */
